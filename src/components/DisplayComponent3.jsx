...
const DisplayComponent2 = () => {
  return (
    <div className="flex justify-center items-center min-h-screen  m-5"     style={{
        background: "linear-gradient(240.94deg, #DFF4FF 0.88%, rgba(230, 221, 255, 0) 56.21%)",
      }}>
      <div className="relative max-w-1/2 rounded-lg overflow-hidden shadow-lg">
